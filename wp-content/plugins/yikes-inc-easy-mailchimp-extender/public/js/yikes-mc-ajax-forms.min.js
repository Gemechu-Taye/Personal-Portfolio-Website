window.Yikes_Mailchimp_Ajax = window.Yikes_Mailchimp_Ajax || {},
    function(e, i, s, a, r) {
        ...
        a.l10n = e.yikes_mailchimp_ajax || {}, s(i).ready(function() {
            s("body").on("submit", ".yikes-easy-mc-form", function() {
                ...
                if (i.find(".yikes-interest-group-required").length > 0 && i.find(".yikes-interest-group-required").each(function() {
                    ...
                    if (i.find(".yikes-mailchimp-required-interest-group-error").length > 0) i.find(".yikes-mailchimp-required-interest-group-error").fadeOut("fast", function() {
                        for (var e in i.find(".yikes-mailchimp-required-interest-group-error").remove(), n) i.find("span." + e + "-label").after('<p class="yikes-mailchimp-required-interest-group-error">' + a.l10n.interest_group_checkbox_error + "</p>")
                    });
                    else
                        for (var o in n) i.find("span." + o + "-label").after('<p class="yikes-mailchimp-required-interest-group-error">' + a.l10n.interest_group_checkbox_error + "</p>");
                    ...
                    return s.ajax({
                        ...
                        success: function(e, n, o) {
                            if (i.find("input, label, button").not(":hidden").fadeTo("fast", 1), i.find(".yikes-mailchimp-preloader").remove(), s(".yikes-mc-loading-dots").remove(), s(".yikes-mailchimp-submit-button-span-text").show(), i.removeClass("yikes-mc-submitted-form-loading"), i.trigger("yikes_mailchimp_ajax_submission", e), e.success) {
                                e = e.data, "function" == typeof yikes_mailchimp_google_analytics_success && yikes_mailchimp_google_analytics_success(e), 1 == e.hide && (s(".yikes-easy-mc-form-description-" + r).length > 0 && s(".yikes-easy-mc-form-description-" + r).hide(), i.hide());
                                ...
                                e = e.data, "function" == typeof yikes_mailchimp_google_analytics_failure && yikes_mailchimp_google_analytics_failure(e);
                                ...
                                if ("before" === a.l10n.feedback_message_placement ? u.before(f) : "after" === a.l10n.feedback_message_placement ? i.after(f) : "both" === a.l10n.feedback_message_placement && (u.before(f), i.after(f)), void 0 !== e && void 0 !== e.missing_required_field && !0 === e.missing_required_field)
                                    if (void 0 !== e.missing_required_field_data) t(e.missing_required_field_data, void 0 !== e.is_interest_group && e.is_interest_group);
